...
?>
                        ...
                        <div class="card stats-card">
                            <div class="card-content">
                                ...
                                <span class="card-title">Отделов</span>
    <?php
...
?>                            
                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                <span class="card-title">Типов отпусков</span>
                                    <?php
                        ...
                        <div class="col s12 m12 l12">
                            <div class="card invoices-card">
                                <div class="card-content">
                                    ...
                                    <span class="card-title">Все</span>
                             <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th width="200">Сотрудник</th>
                                            <th width="120">Тип отпуска</th>
...
if($stats==1){
                                             ?>
                                                ...
                                                <span style="color: red">Не утвержден</span>
                                                 <?php } if($stats==0)  { ?>
 <span style="color: blue">Ожидает утверждения</span>
 <?php } ?>
          ...
          <td>
           <td><a href="leave-details.php?leaveid=<?php echo htmlentities($result->lid);?>" class="waves-effect waves-light btn blue m-b-xs"  >Подробности</a></td>
                                    </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                </table>
